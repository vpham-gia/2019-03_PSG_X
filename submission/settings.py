...
NEXT_TEAM_MODEL_BASE_HYPERPARAMS = NEXT_TEAM_MODEL_HYPERPARAMS['base'][NEXT_TEAM_MODEL_TYPE]
NEXT_TEAM_RANDOM_SEARCH_HYPERPARAMS = NEXT_TEAM_MODEL_HYPERPARAMS['random_search'][NEXT_TEAM_MODEL_TYPE]
